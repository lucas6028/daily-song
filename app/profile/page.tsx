  ...
  return (
    <>
      ...
      <div className={`${styles.container} d-flex justify-content-center mt-4`}>
        <Card
          className={`shadow-lg bg-secondary bg-gradient text-light rounded-3 ${styles.card}`}
          style={{ width: '20rem' }}
        >
          <Card.Img
            className={`rounded-circle mx-auto mt-3 ${styles.img}`}
            variant="top"
            src={profile.imgUrl}
            alt="Profile Picture"
          />
          <Card.Body className="text-center">
            ...
            <Card.Text className="mb-3">
              <ul className="list-unstyled">
                <li>
                  <strong>Subscription:</strong> {profile.product}
                </li>
                <li>
