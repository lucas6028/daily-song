// In the same file or another file (e.g., styles.js or constants.js)
const spotifyPlayerStyles = {
  height: 50,
  activeColor: '#1DB954', // Bright Spotify green for active elements
  bgColor: 'transparent', // Transparent background for a cleaner look
  // bgColor: '#333', // Alternative dark background
...
export default spotifyPlayerStyles;
